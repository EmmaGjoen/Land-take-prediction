...
#SBATCH --job-name=utae_tessera_K${K:-2}_N${INPUT_YEARS:-all}
...
#SBATCH --mem=32G
#SBATCH --output=logs/utae_tessera/utae_tessera_%j.out
#SBATCH --error=logs/utae_tessera/utae_tessera_%j.err
...
CMD="python train_utae_tessera.py --prediction_horizon $K"
