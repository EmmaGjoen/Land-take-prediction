#!/bin/bash
#
# 5-fold geographic CV for U-TAE + Sentinel-2.
...
#SBATCH --mem=32G
#SBATCH --array=0-4
#SBATCH --output=logs/utae_sentinel/fold%a_%A.out
#SBATCH --error=logs/utae_sentinel/fold%a_%A.err

echo "=========================================="
echo "Starting U-TAE + Sentinel-2 training job"
